...
name="sunkaiah achari i am a bad boy"
def m(name):
    if name=="a":
        return name           
a=filter(m,name)
...
l=[1,2,-3,11,12.5,13,14,15,-16,17,18.2,True,"SUNKU"]                
a=filter(m,l)
print(list(a)) 

#here boolean is not removed because here true is considered as integer "1"():

l=[1,2,-3,11,12.5,13,14,15,-16,17,18.2,True,"pandu"]
